...
/* harmony import */ var _index_66edb21f_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-66edb21f.js */ "./node_modules/@ionic/core/dist/esm/index-66edb21f.js");
/* harmony import */ var _cubic_bezier_685f606a_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cubic-bezier-685f606a.js */ "./node_modules/@ionic/core/dist/esm/cubic-bezier-685f606a.js");
/* harmony import */ var _gesture_controller_89173521_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./gesture-controller-89173521.js */ "./node_modules/@ionic/core/dist/esm/gesture-controller-89173521.js");
/* harmony import */ var _index_eea61379_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-eea61379.js */ "./node_modules/@ionic/core/dist/esm/index-eea61379.js");
/* harmony import */ var _hardware_back_button_7b6ede21_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./hardware-back-button-7b6ede21.js */ "./node_modules/@ionic/core/dist/esm/hardware-back-button-7b6ede21.js");
/* harmony import */ var _overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./overlays-7369bfcc.js */ "./node_modules/@ionic/core/dist/esm/overlays-7369bfcc.js");
...
/* harmony import */ var _framework_delegate_d1eb6504_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./framework-delegate-d1eb6504.js */ "./node_modules/@ionic/core/dist/esm/framework-delegate-d1eb6504.js");
...
var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
  ...
  var onMove = function onMove(detail) {
    var step = Object(_helpers_5c745fbd_js__WEBPACK_IMPORTED_MODULE_7__["c"])(0.0001, detail.deltaY / height, 0.9999);
  ...
  var onEnd = function onEnd(detail) {
    ...
    if (!shouldComplete) {
      ...
      newStepValue += Object(_cubic_bezier_685f606a_js__WEBPACK_IMPORTED_MODULE_10__["g"])([0, 0], [1, 0], [0.68, 0.28], [1, 1], step)[0];
    } else {
      animation.easing('cubic-bezier(0.32, 0.72, 0, 1)');
      newStepValue += Object(_cubic_bezier_685f606a_js__WEBPACK_IMPORTED_MODULE_10__["g"])([0, 0], [0.32, 0.72], [0, 1], [1, 1], step)[0];
    }
  ...
  var gesture = Object(_index_eea61379_js__WEBPACK_IMPORTED_MODULE_12__["createGesture"])({
    el: el,
...
var computeDuration = function computeDuration(remaining, velocity) {
  return Object(_helpers_5c745fbd_js__WEBPACK_IMPORTED_MODULE_7__["c"])(400, remaining / Math.abs(velocity * 1.1), 500);
};
/**
...
var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
  var backdropAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  var wrapperAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  var baseAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().afterStyles({
          'transform': _finalTransform
...
var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
  ...
  var backdropAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
  var wrapperAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  var baseAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_a635a2fc_js__WEBPACK_IMPORTED_MODULE_8__["c"])().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
          'transform': 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
var Modal = /*#__PURE__*/function () {
  function Modal(hostRef) {
    ...
    Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(this, Modal);

    Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["r"])(this, hostRef); // Whether or not modal is being dismissed via gesture
    ...
    this.onBackdropTap = function () {
      _this.dismiss(undefined, _overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["B"]);
    };
    ...
    Object(_overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["d"])(this.el);
    this.didPresent = Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["c"])(this, "ionModalDidPresent", 7);
    this.willPresent = Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["c"])(this, "ionModalWillPresent", 7);
    this.willDismiss = Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["c"])(this, "ionModalWillDismiss", 7);
    this.didDismiss = Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["c"])(this, "ionModalDidDismiss", 7);
  }

  Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Modal, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 8;
                return Object(_framework_delegate_d1eb6504_js__WEBPACK_IMPORTED_MODULE_16__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);

              case 8:
                this.usersElement = _context.sent;
                _context.next = 11;
                return Object(_index_66edb21f_js__WEBPACK_IMPORTED_MODULE_9__["e"])(this.usersElement);
              ...
              case 11:
                ...
                _context.next = 14;
                return Object(_overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
    ...
    value: function initSwipeToClose() {
      ...
      var animationBuilder = this.leaveAnimation || _ionic_global_08f4fb8a_js__WEBPACK_IMPORTED_MODULE_6__["c"].get('modalLeave', iosLeaveAnimation);
      ...
      this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
        ...
        _this3.animation.onFinish( /*#__PURE__*/Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2() {
    ...
    key: "dismiss",
    value: function () {
      var _dismiss2 = Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(data, role) {
        ...
        return _Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                enteringAnimation = _overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["h"].get(this) || [];
                _context3.next = 5;
                return Object(_overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
              ...
              case 5:
                ...
                _context3.next = 9;
                return Object(_framework_delegate_d1eb6504_js__WEBPACK_IMPORTED_MODULE_16__["d"])(this.delegate, this.usersElement);
    ...
    value: function onDidDismiss() {
      return Object(_overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["g"])(this.el, 'ionModalDidDismiss');
    }
    /**
    ...
    value: function onWillDismiss() {
      return Object(_overlays_7369bfcc_js__WEBPACK_IMPORTED_MODULE_14__["g"])(this.el, 'ionModalWillDismiss');
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["h"])(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["H"], {
        ...
        "aria-modal": "true",
        tabindex: "-1",
        class: Object.assign((_Object$assign = {}, Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, mode, true), Object(_Users_jrquick_development_encounting_ionic4_auto_complete_demo_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, "modal-card", this.presentingElement !== undefined && mode === 'ios'), _Object$assign), Object(_theme_3f0b0c04_js__WEBPACK_IMPORTED_MODULE_15__["g"])(this.cssClass)),
        style: {
      ...
      }), mode === 'ios' && Object(_index_29df6f59_js__WEBPACK_IMPORTED_MODULE_5__["h"])("div", {
        class: "modal-shadow"
