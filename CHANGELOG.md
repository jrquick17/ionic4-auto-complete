...
## [Unreleased]
### Updated
* Pin supported Node version (`.nvmrc`, `engines.node`) to `^18.13.0 || >=20.9.0` by [jrquick17](https://github.com/jrquick17)
...
* Improve documentation formatting by [waratah](https://github.com/waratah)
